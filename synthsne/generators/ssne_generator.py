...
from lchandler.lc_classes import get_new_noisy_obs
...
class SynSNeGenerator():
    def __init__(self, lcobj, class_names, band_names, obse_sampler_bdict, uses_estw,
                 ...
                 std_scale=_C.OBSE_STD_SCALE,
                 min_cadence_days=_C.MIN_CADENCE_DAYS,
                 min_synthetic_len_b=_C.MIN_POINTS_LIGHTCURVE_DEFINITION,
